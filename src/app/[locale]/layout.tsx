      ...
      <body className={`${montserrat.variable} min-h-screen font-sans`}>
        ...
        <NextIntlClientProvider messages={messages}>
          <Providers>
            <a
              href="#main-content"
              className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-[max(1rem,env(safe-area-inset-top,0px))] focus:z-[100] focus:rounded-lg focus:border focus:border-white/20 focus:bg-stone-950 focus:px-4 focus:py-2 focus:text-sm focus:text-stone-100"
            >
              {tCommon("skip_main")}
            </a>
            <ScrollToHash />
