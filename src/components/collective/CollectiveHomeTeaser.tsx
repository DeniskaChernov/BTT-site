          ...
          <div className="relative flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between md:gap-10">
            ...
            {botUrl ? (
              <a
                ...
                className={cn(
                  "btt-focus inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber-500 to-orange-600 px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-amber-900/35 transition hover:brightness-105 active:scale-[0.98]",
                  bttTapReduceClass,
                )}
              >
            ...
            {channelUrl ? (
              <a
                ...
                rel="noopener noreferrer"
                className={cn(
                  "btt-focus inline-flex items-center justify-center rounded-full border border-white/15 bg-black/25 px-7 py-3.5 text-sm font-semibold text-stone-200 backdrop-blur-sm transition hover:border-white/25 hover:bg-black/40 active:scale-[0.98]",
                  bttTapReduceClass,
                )}
              >
                {t("cta_channel")}
