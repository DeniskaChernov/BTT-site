  ...
  return (
    ...
    >
      <div className="btt-container">
        ...
        >
          <div
            className="pointer-events-none absolute -right-16 -top-20 h-52 w-52 rounded-full bg-white/[0.05] blur-3xl"
            aria-hidden
          />
          ...
          <ul className="mt-8 grid gap-4 sm:grid-cols-3">
            {items.map(({ title, desc, Icon }, i) => (
              <motion.li
                ...
                className="group relative flex h-full flex-col gap-3 rounded-2xl border border-white/[0.07] bg-black/25 p-5 shadow-inner shadow-black/20 transition-colors duration-200 hover:border-white/20 hover:bg-black/35 motion-reduce:hover:translate-y-0 md:p-6"
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-white/[0.08] to-black/25 text-stone-100 ring-1 ring-white/[0.06] transition-transform duration-200 group-hover:scale-105 motion-reduce:group-hover:scale-100">
