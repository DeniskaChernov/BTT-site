...
export function HomeHitsClient({ kicker, title, lead, cta, fallback }: Props) {
  return (
    <section id="hits" className="relative scroll-mt-24 py-10 md:py-14">
      ...
      <div className="relative btt-container">
        ...
        <HomeHitsGrid fallback={fallback} />
      </div>
    </section>
  );
}
