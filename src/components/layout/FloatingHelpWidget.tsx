...
import { bttWarmGlassSurfaceClass } from "@/lib/ui-classes";
              ...
              <li>
                <motion.a
                  ...
                  className={cn(
                    ...
                    "btt-focus flex items-center gap-3 rounded-2xl px-3.5 py-2.5 text-sm font-semibold",
                  )}
                >
      ...
      <motion.button
        ...
        className={cn(
          ...
          open
            ...
            : cn(bttWarmGlassSurfaceClass, "rounded-full"),
        )}
      >
