    ...
    <div className="btt-container py-10 md:py-16">
      <SectionReveal>
        ...
        <div className="mt-6 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <AnimatedReveal delay={0.08} className="flex flex-wrap gap-3">
            <a
              href={PDF_HREF}
      ...
      <SectionReveal className="mt-10">
        <div className="overflow-hidden rounded-2xl border border-white/[0.1] bg-stone-950/80 shadow-2xl shadow-black/40">
          <iframe
      ...
      <AnimatedReveal className="mt-4 text-center text-xs text-stone-500">
        <p>{t("footer_note")}</p>
      </AnimatedReveal>
    </div>
  );
